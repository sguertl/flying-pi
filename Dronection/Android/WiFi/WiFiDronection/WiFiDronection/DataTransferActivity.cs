...
namespace WiFiDronection
{
    ...
    public class DataTransferActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            while (!SocketConnection.m_Socket.IsConnected)
            {
            ...
            if (SocketConnection.FLAG)
            {
                ...
                this.mOutputStream = new DataOutputStream(SocketConnection.m_Socket.OutputStream);
            }
            else
            {
                try
        ...
        private void Cancel()
        {
            ...
            {
                mOutputStream.Close();
                SocketConnection.m_Socket.Close();
            }
            catch (System.Exception ex)
            {
                System.Console.WriteLine(ex.Message);
